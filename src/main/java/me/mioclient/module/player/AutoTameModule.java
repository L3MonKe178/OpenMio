...
public class AutoTameModule extends Module {
   ...
   public final Timer field_1366;

   public AutoTameModule() {
      super("AutoTame", "Automatically interacts with tame-able entities.", Category.PLAYER);
      Settings.initialize(this);
      this.field_1366 = new Timer();
   }

   @Subscribe
   public void method_2(Event_19 var1) {
      if (var1.method_213() != PreType.POST) {
         if (this.field_1366.method_2((double)(this.field_1360.getValue() != null ? this.field_1360.getValue().floatValue() : 0.0f), TimeUnit.SECONDS)) {
            int var2 = 0;
            ...
            for (Entity var4 : field_4219.world.getEntities()) {
               if (var4 instanceof TameableEntity) {
                  ...
                  if (this.method_2(var5) && var4.distanceTo(field_4219.player) <= this.field_1358.getValue()) {
                     if (this.field_1357 == null || this.field_1357.getValue() == null) continue;
                     Vec3d var6 = (this.field_1357.getValue() != null ? this.field_1357.getValue().method_5(var5) : null);
                     if (var6 != null) {
                        var2++;
                        if (this.field_1361.getValue()) {
                           var1.method_5(RotationManager.method_78(var6));
                        }
