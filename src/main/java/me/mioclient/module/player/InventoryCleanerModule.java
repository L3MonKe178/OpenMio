...
public class InventoryCleanerModule extends Module {
   ...
   public void method_2(Event_1 var1) {
      int var2 = 0;
      if (this.field_1279.method_9((long)this.field_1275.getValue().intValue())) {
         ...
         if (!this.field_1277.getValue() || var4) {
            ...
            for (Slot var7 : field_4219.player.currentScreenHandler.slots) {
               ...
               if (!var8.isEmpty()
                  && this.field_1274.getValue().method_2(var8.getItem(), this.field_1273)
