   ...
   public void method_2(Event_1 var1) {
      if (this.field_2154.getValue()) {
         ...
         if (!var3.isOf(Blocks.AIR) && !var3.getCollisionShape(field_4219.world, var2).isEmpty()) {
            field_4219.options.sneakKey.setPressed(!this.field_2156.method_9((long)(this.field_2155.getValue() != null ? this.field_2155.getValue().intValue() : 0)));
         } else {
