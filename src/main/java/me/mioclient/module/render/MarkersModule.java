...
public class MarkersModule extends Module {
   ...
   public void method_2(Event_26 var1) {
      float var2 = MathHelper.lerp(RenderUtil.method_776(), field_4219.player.prevYaw, field_4219.player.getYaw());
      ...
      for (AbstractClientPlayerEntity var4 : field_4219.world.getPlayers()) {
         ...
         if (field_4219.player != var4 && !(var5 > Double.longBitsToDouble(4629700416936869888L))) {
            ...
            if (!((double)var7 < Double.longBitsToDouble(4591870180066957722L))) {
               float var8 = RotationManager.method_7(this.method_209(field_4219.player), this.method_209(var4))[0];
               if (!this.field_1077.getValue()
                  ...
                  double var9 = Math.toRadians((double)(var8 - var2 - (float)Constants.field_685));
                  float var11 = FontRenderer.field_3143.method_221(">") * Float.intBitsToFloat(1056964608);
                  float var12 = MathHelper.clamp(
                        field_4219.player.getPitch() + Float.intBitsToFloat(1106247680), (float)(-Constants.field_685), (float)Constants.field_685
                     )
                     / (float)Constants.field_685;
                  float var13 = (float)(
                     Math.cos(var9) * (double)(this.field_1076.getValue() != null ? this.field_1076.getValue().floatValue() : 0.0f) + (double)var1.method_881().getScaledWindowWidth() * Constants.field_688
                  );
                  float var14 = (float)(
                     Math.sin(var9) * (double)(this.field_1076.getValue() != null ? this.field_1076.getValue().floatValue() : 0.0f) * (double)var12
                        + (double)var1.method_881().getScaledWindowHeight() * Constants.field_688
                  );
                  var1.method_10().push();
                  ...
                  FontRenderer.field_3143
                     .method_2(
                        ...
                        ">",
                        -var11,
                        (float)((double)(-FontRenderer.field_3143.method_66()) * Constants.field_688),
   ...
   public Vec3d method_209(PlayerEntity var1) {
      return new Vec3d(
         MathHelper.lerp((double)RenderUtil.method_776(), var1.prevX, var1.getX()),
         MathHelper.lerp((double)RenderUtil.method_776(), var1.prevY, var1.getY()),
         MathHelper.lerp((double)RenderUtil.method_776(), var1.prevZ, var1.getZ())
      );
   }
}
