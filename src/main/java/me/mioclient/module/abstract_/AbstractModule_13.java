...
public final class AbstractModule_13 extends Module {
   ...
   public final Class_0242 field_3592;
   public final Class_0242 field_3593;
   ...
   public AbstractModule_13() {
      super(
         "BedAura",
         new Class_1303().method_2(String.valueOf(Formatting.RED)).method_9("Blows your enemies up using beds. \n\u0001Doesn't work in the overworld."),
         Category.COMBAT
      );
      Settings.initialize(this);
      this.field_3590 = new Class_0532(this);
      this.field_3591 = new Class_0470(this);
      this.field_3592 = new Class_0242();
      this.field_3593 = new Class_0242();
      Hub.field_2616
         .method_2(
   ...
   public void method_2(Class_1183 var1) {
      int var2 = Class_0136.method_7((Predicate<ItemStack>)(var0 -> var0.getItem() instanceof BedItem));
      ...
      if (var1 != null) {
         if (Class_1035.method_7(var1.method_1037(), true)) {
            ...
            if (this.field_3569.getValue()) {
               var2 = Class_0485.method_78(var1.method_1041().getPos());
            } else {
               var2 = Class_0485.method_7(var1.method_1037().toCenterPos(), var1.method_1038().toCenterPos());
            }

            Hub.field_2598.method_2(var2, 500);
            BlockHitResult var3 = var1.method_1041();
            Hub.field_2615.method_3(() -> Class_1261.method_2(Hand.MAIN_HAND, var3));
            ...
            if (this.field_3576.getValue()) {
               Hub.field_2615.method_22(() -> {
                  ...
                  Class_1261.method_2(Hand.MAIN_HAND, var3x);
                  field_4219.player.swingHand(Hand.MAIN_HAND);
               });
            }
   ...
   public void method_1024() {
      if (this.field_3579.getValue()) {
         ...
         if (!(var2.getItem() instanceof BedItem)) {
            int var3 = Class_0136.method_2((Predicate<ItemStack>)(var0 -> var0.getItem() instanceof BedItem), true);
            if (var3 != -1) {
               Class_0136.method_9(var3, Class_0136.method_30(var1));
            }
         }
      }
   }
   ...
   public boolean method_2(Class_0242 var1, Setting<Integer> var2) {
