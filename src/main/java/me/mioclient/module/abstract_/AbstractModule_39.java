...
public class AbstractModule_39 extends Module {
   ...
   public AbstractModule_39() {
      super(
         "AnchorAura",
         new TextBuilder().method_2(String.valueOf(Formatting.RED)).method_9("Explodes respawn anchors to kill players. \n\u0001Doesn't work in the nether."),
         Category.COMBAT
      );
      Settings.initialize(this);
      this.field_3790 = new Mutable();
      this.field_3791 = new Timer();
   ...
   public void method_5(Event_7 var1) {
      if (field_4219.world.getDimension().respawnAnchorWorks()) {
         ChatUtil.method_2(Text.of("Doesn't work in the nether!"), ChatUtil.method_38(-1), Priority.HIGH);
         this.disable();
      } else {
         this.method_1061();
         if (!this.method_639()) {
               ...
               if (this.method_12() != null) {
                  ...
                  if (var4.isOf(Blocks.RESPAWN_ANCHOR)) {
                     ...
                     if (this.field_3774.getValue()) {
                        Hub.field_2598.method_2(RotationManager.method_78(var3.toCenterPos()), 100);
                     }
   ...
   public void method_2(BlockPos var1, Direction var2, int var3) {
      Vec3d var4 = var1.toCenterPos().offset(var2, Constants.field_688);
      Hand var5 = PlayerUtil.method_7(Items.GLOWSTONE);
      if (this.field_3774.getValue()) {
         Hub.field_2598.method_2(RotationManager.method_78(var4), 100);
      }

      if (var5 != null) {
         this.method_2(var1, var2, var4, Hand.MAIN_HAND);
      } else {
         int var6 = PlayerUtil.method_5(Items.GLOWSTONE);
         if (var6 != -1) {
   ...
   public void method_2(BlockPos var1, Direction var2, Hand var3) {
      if (!this.method_176(var1)) {
         ...
         int var5 = PlayerUtil.method_5(Items.RESPAWN_ANCHOR);
         boolean var6 = Class_1035.method_78(var1) == null && field_3764.method_1052() && this.field_3776.getValue();
         if (var5 != -1 || var3 != Hand.MAIN_HAND) {
            if (this.field_3774.getValue()) {
               Hub.field_2598.method_2(RotationManager.method_2(var1.toCenterPos(), var2), 100);
            }
   ...
   public void method_2(BlockPos var1, Direction var2, Vec3d var3, Hand var4) {
      Hub.field_2615.method_22(() -> {
         PacketUtil.method_2(Hand.MAIN_HAND, new BlockHitResult(var3, var2, var1, false));
         PacketUtil.method_9(var4);
      });
   }
   ...
   public void method_1061() {
      ...
      if (this.field_3789 == null || this.field_3789.isDone() || this.field_3789.isCancelled()) {
         if (this.field_3793 != null && Class_1073.method_2(this.field_3793.method_956(), (double)(this.field_3770.getValue() != null ? this.field_3770.getValue().floatValue() : 0.0f))) {
            this.field_3793 = null;
         }
   ...
   public Vec3d method_310(BlockPos var1) {
      ...
      return var2.stream()
         .filter(var1x -> Class_1225.method_9(var1x) || field_4219.player.getEyePos().distanceTo(var1x) <= (double)(this.field_3769.getValue() != null ? this.field_3769.getValue().floatValue() : 0.0f))
   ...
   public Class_0835 method_1062() {
      ...
      for (double var2 = -Math.floor((double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f));
         var2 < Math.ceil((double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f));
         var2 += Double.longBitsToDouble(4607182418800017408L)
      ) {
         for (double var4 = -Math.floor((double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f));
            var4 < Math.ceil((double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f));
            var4 += Double.longBitsToDouble(4607182418800017408L)
         ) {
            for (double var6 = -Math.floor((double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f));
               var6 < Math.ceil((double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f));
               ...
               if ((Class_1035.method_2(this.field_3790, Blocks.RESPAWN_ANCHOR, true, false) || this.method_176(this.field_3790))
                  ...
                  if ((var9 || !(var10 > (double)(this.field_3769.getValue() != null ? this.field_3769.getValue().floatValue() : 0.0f))) && !(var10 > (double)(this.field_3768.getValue() != null ? this.field_3768.getValue().floatValue() : 0.0f))) {
   ...
   public Class_1073 method_270(BlockPos var1) {
      ...
      for (PlayerEntity var4 : field_4219.world.getPlayers()) {
         if (!Class_1073.method_2(var4, (double)(this.field_3770.getValue() != null ? this.field_3770.getValue().floatValue() : 0.0f))) {
            ...
            if (!((double)(this.field_3771.getValue() != null ? this.field_3771.getValue().floatValue() : 0.0f) > var5) && !(var5 < Constants.field_688) && (var2 == null || var5 > var2.method_445())) {
   ...
   public Hand method_12() {
      ...
      Hand var2 = PlayerUtil.method_7(Items.RESPAWN_ANCHOR);
      if (var1 && var2 == null) {
         return null;
      } else {
   ...
   public boolean method_2(BlockPos var1, Class_1073 var2) {
      if (var2 == null) {
         ...
         boolean var9 = !var6 && var4 >= (double)(this.field_3772.getValue() != null ? this.field_3772.getValue().floatValue() : 0.0f)
            || var4 >= (double)Class_0396.method_76() && this.field_3773.getValue();
         if (var3 && !var9) {
            return false;
         } else {
            return !((double)(this.field_3771.getValue() != null ? this.field_3771.getValue().floatValue() : 0.0f) > var7) && !(var7 < Constants.field_688) ? var9 : true;
         }
      }
   }
