...
public class AbstractModule_15 extends AbstractModule_26 {
   ...
   public void method_2(DrawContext var1) {
      ItemStack var2 = new ItemStack(Items.TOTEM_OF_UNDYING, Class_0136.method_29((Predicate<ItemStack>)(var0 -> var0.isOf(Items.TOTEM_OF_UNDYING))));
      if (var2.getCount() != 0) {
         ...
         if (var2.getCount() > 1) {
            ...
            Class_1016.field_3143
               .method_9(
                  var1,
                  var3,
                  Float.intBitsToFloat(1099431936) - Class_1016.field_3143.method_221(var3),
