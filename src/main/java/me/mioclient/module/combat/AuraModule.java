...
public class   AuraModule extends Module {
      ...
      if ((this.method_3(field_4219.player.getMainHandStack().getItem()) || this.field_1056.getValue() != Class_0768.REQUIRE) && !var2) {
         if (field_4219.player.currentScreenHandler == field_4219.player.playerScreenHandler || !field_1041.method_1052()) {
            this.field_582 = Class_1225.method_2(
               ...
               this.field_1042.getValue().method_55(),
               this::method_374
            );
            Hub.field_2630.method_9(this);
            ...
            if (this.field_582 == null) {
               this.method_372();
            } else if (!Class_0485.method_513() || this.method_107(this.field_582) || field_4219.player.isFallFlying()) {
               this.method_300();
               if (this.field_1049.getValue()) {
                  ...
                  float[] var3 = Class_0485.method_2(Class_0485.method_14(this.field_582), Hub.field_2598.method_509());
   ...
   public void method_9(Event_3 var1) {
      if (this.field_1051.getValue()) {
         ...
         Color var4 = Class_1081.method_9(this.field_1052.getValue(), (int)((float)this.field_1052.getValue().getAlpha() * var2));
         Color var5 = Class_1081.method_9(this.field_1053.getValue(), (int)((float)this.field_1053.getValue().getAlpha() * var2));
   ...
   public Box method_370() {
      ...
      if (var2 != null) {
         var1 = Class_0719.method_2(var2, Class_0838.method_776());
         ...
         if (this.method_107(this.field_582)) {
            ...
            if (!(Class_1225.method_39(this.field_582) > (double)var1)) {
               ...
               if (field_1040.isToggled()
                  ...
                  int var4 = Class_0136.method_7((Predicate<ItemStack>)(var0 -> var0.getItem() instanceof AxeItem || var0.getItem() instanceof SwordItem));
   ...
   public boolean method_107(Entity var1) {
      ...
      double var4 = (double)this.field_1044.getValue().floatValue();
      return (double)this.method_371() >= var4;
   }

   public float method_371() {
      double var1 = Class_0245.field_688;
   ...
   public boolean method_3(Item var1) {
      return var1 instanceof SwordItem
         ...
         || var1 instanceof PickaxeItem
            && Class_0136.method_7((Predicate<ItemStack>)(var0 -> var0.getItem() instanceof SwordItem || var0.getItem() instanceof AxeItem)) == -1;
   }
   ...
   public int method_373() {
      if (this.field_1057.getValue() == Class_0001.SILENT && this.method_375()) {
         ...
         int var1 = Class_0136.method_7((Predicate<ItemStack>)(var1x -> var1x.isOf(Items.MACE) && this.field_1058.getValue().method_16(var1x)));
         return this.field_1058.getValue() == Class_0885.SMART && field_4219.player.fallDistance > Float.intBitsToFloat(1077936128) && var1 == -1
            ? Class_0136.method_7((Predicate<ItemStack>)(var0 -> var0.isOf(Items.MACE)))
            : var1;
      }
   }

   public boolean method_374(Entity var1) {
      float[] var2 = Class_0485.method_14(var1);
