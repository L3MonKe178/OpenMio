...
public final class Class_0258 {
   ...
   public HitResult method_263() {
      float var1 = this.field_785[1] * Constants.field_690;
      float var2 = -this.field_785[0] * Constants.field_690;
      ...
      Class_0512 var9 = new Class_0533(MioAPI.field_4219.player.getEyePos(), var8)
