...
public enum Class_0885 implements Nameable {
   NONE("None", var0 -> false),
   BREACH("Breach", var0 -> Class_0756.method_9(Enchantments.BREACH, var0)),
   DENSITY("Density", var0 -> Class_0756.method_9(Enchantments.DENSITY, var0) && MioAPI.field_4219.player.fallDistance > 3.0F),
   SMART(
      "Smart",
      var0 -> !(MioAPI.field_4219.player.fallDistance > 3.0F) && Hub.field_2615.method_1161() > 1
