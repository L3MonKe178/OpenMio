...
public class Class_1162 extends Class_0121 implements Class_1309 {
      ...
      super(
         () -> {
            ...
            if (var1x == null) {
               ...
               String var3 = var1x.getAmplifier() == 0 ? "" : new Class_1303().method_2(var1x.getAmplifier() + 1).method_9("\u0001 ");
