...
public class Class_0056<S> extends LiteralCommandNode<S> {
   public Class_0056(String var1, Command<S> var2, Predicate<S> var3, CommandNode<S> var4, RedirectModifier<S> var5, boolean var6) {
   ...
   public CompletableFuture<Suggestions> listSuggestions(CommandContext<S> var1, SuggestionsBuilder var2) {
      ...
      return super.listSuggestions(var1, var2);
   }
}
