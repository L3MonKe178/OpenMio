...
public class Class_0534 extends Class_0914 {
   public static final Identifier field_1682 = Identifier.of("mio-mount", "textures/overlay.png");
   public static ShaderModule field_786 = Hub.field_2595.method_78(ShaderModule.class);

   public Class_0534() {
      super();
      this.method_251("bloom");
   }

   @Override
   public boolean method_291() {
      return field_786.isToggled() && field_786.field_2017.getValue() == Class_0151.BLOOM;
   }
   ...
   public void method_292() {
      ...
      int var1 = field_4219.getTextureManager().getTexture(field_1682).getGlId();
      ...
      this.field_2303.method_2("u_GlowQuality", field_786.field_2022.getValue());
      this.field_2303
         .method_2(
            "u_FillColor",
            field_786.method_651() ? Class_1081.method_29(field_786.field_2038.getValue()) : field_786.method_30(field_786.field_2036.getValue())
         );
