...
public final class Class_0335 extends Command {
   public Class_0335() {
      super("clip");
   }
                        ...
                        var0 -> {
                           ...
                           if (field_4219.player.hasVehicle()) {
                              for (int var4 = 0; var4 < var2 - 1; var4++) {
                                 PacketUtil.method_2(new VehicleMoveC2SPacket(field_4219.player.getVehicle()));
                              }
                              ...
                              for (int var3 = 0; var3 < var2 - 1; var3++) {
                                 PacketUtil.method_2(new OnGroundOnly(true));
                              }

                              field_4219.player.setPosition(field_4219.player.getX(), field_4219.player.getY() + (double)var1x, field_4219.player.getZ());
                              PacketUtil.method_2(field_4219.player.getX(), field_4219.player.getY() + (double)var1x, field_4219.player.getZ(), true);
                              return 1;
                           }
                        }
                     )
                  ...
                  RequiredArgumentBuilder.<CommandSource, Float>argument("value", FloatArgumentType.floatArg())
                     .executes(
                        var0 -> {
                           ...
                           double var2 = Math.cos(Math.toRadians((double)(field_4219.player.getYaw() + (float)Constants.field_685)));
                           double var4 = Math.sin(Math.toRadians((double)(field_4219.player.getYaw() + (float)Constants.field_685)));
                           if (field_4219.player.hasVehicle()) {
                              field_4219.player
                                 .getVehicle()
                                 .setPosition(
