...
public class Class_0249 extends Class_0618 {
   ...
   public void exec(LiteralArgumentBuilder<CommandSource> var1) {
      var1.then(
         RequiredArgumentBuilder.<CommandSource, Vec3d>argument("pos", new Class_0019()).then(LiteralArgumentBuilder.<CommandSource>literal("yawlock").executes(var0 -> {
            float[] var1x = Class_0485.method_78((Vec3d)var0.getArgument("pos", Vec3d.class));
            field_711.field_1477.method_78(var1x[0]);
            return 1;
         })).executes(var0 -> {
            float[] var1x = Class_0485.method_78((Vec3d)var0.getArgument("pos", Vec3d.class));
            Class_1245.method_2(Text.literal("Calculated angle. Yaw: %.1f, Pitch: %.1f.".formatted(var1x[0], var1x[1])), Class_1245.method_38(-1));
            return 1;
         })
      );
   }
