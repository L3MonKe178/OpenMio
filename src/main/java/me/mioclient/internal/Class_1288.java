...
public class Class_1288 implements Class_1309 {
   ...
   public boolean method_2(ItemEntity var1) {
      if (this.field_4170.intersects(var1.getBoundingBox())) {
         ...
         this.field_4172 = Math.max(Class_1016.field_3143.method_221(method_5(var3, this.field_4169.get(var3))), this.field_4172);
   ...
   public static String method_5(String var0, int var1) {
      return var1 <= 1 ? var0 : new Class_1303().method_2(var1).method_2((Object)var0).method_9("\u0001 x\u0001");
   }
}
